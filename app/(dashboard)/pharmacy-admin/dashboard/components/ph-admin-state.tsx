...
import { CreditCardIcon, DollarSign, File, Users2 } from "lucide-react";

export default function PharmacyAdminStats() {
  const data = [
    {
      text: "Sales Today",
      total: "6000",
    ...
    },
    {
      ...
      total: "536",
      color: "warning",
      icon: <CreditCardIcon className="w-4 h-6 text-white" />,
    },
    {
      text: "Medicine",
      total: "234,1",
      ...
      {data.map((item, index) => (
        ...
        >
          ...
          >
            <span
              className={cn(
                `h-8 w-8 rounded-full grid place-content-center  bg-${item.color}`,
                {
