...
import LogInForm from "../coponent/loginform";
    ...
    <div className="  bg-primary  flex  justify-center items-center">
      ...
      >
        <div className="relative  rounded-xl">
          <div className="flex flex-col xl:flex-row  h-screen w-full gap-x-12">
            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px] ">
              ...
              <div className="bg-primary h-full w-full rounded-3xl rounded-tr-none  xl:p-[60px]  xl:pl-9 relative  overflow-hidden">
                <svg
