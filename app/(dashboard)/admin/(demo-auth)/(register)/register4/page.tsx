...
const RegisterPage = () => {
  ...
  return (
    <div className="loginwrapper  bg-primary  flex  justify-center items-center ">
      <div
        className="flex flex-col gap-4 justify-center bg-background my-10 p-10 2xl:my-12 m-4 w-fit overflow-hidden xl:w-[calc(100vw-80px)]   2xl:w-[calc(100vw-160px)]  2xl:px-20 2xl:py-12 rounded-3xl  
      "
      >
        <div className="relative  rounded-xl">
          <div className="flex flex-col xl:flex-row items-center w-full gap-x-4">
            ...
            <div className="basis-full xl:basis-1/2 hidden xl:block relative w-[500px] ">
              ...
              >
                ...
                <defs>
                  ...
                  >
                    <stop stop-color="#826AF9" stopOpacity="0.6" />
                    <stop offset="1" stop-color="#826AF9" stopOpacity="0" />
                  </radialGradient>
                </defs>
              </svg>
