  ...
  return (
    <div className="space-y-6">
      ...
      <Card title="Auto Destroyable Modal" code={autoDistroyAble}>
        <div className="mb-4">
          <p className="text-sm text-default-500 ">
            Auto Destroyable dialog will close after{" "}
      ...
      <Card title="Modal With Radio Inputs" code={withRadioInput}>
        <div className="mb-4">
          <p className="text-sm text-default-500 ">
            Use{" "}
            <span className="text-primary">RadioGroup and RadioGroupItem</span>{" "}
            component to use radio input.
          </p>
        </div>
        <RadioInputsDialog />
      </Card>
      <Card title="Dialog With Timeline" code={withTimeline}>
        <div className="mb-4">
          <p className="text-sm text-default-500 ">
            You can use timeline component in{" "}
            <span className="text-primary">dialog component</span>.
          </p>
        </div>
        <DialogWithTimeline />
      </Card>
      <Card title="Dialog With Progressbar" code={withProgressBar}>
        <div className="mb-4">
          <p className="text-sm text-default-500 ">
            You can use <span className="text-primary">progressbar</span> in
            dialog component.
          </p>
        </div>
      ...
      <Card title="Toggle Between Modal" code={toggleDialog}>
        <div className="mb-4">
          <p className="text-sm text-default-500 ">
            Use simple condition for{" "}
            <span className="text-primary">toggle</span> modal
          </p>
        </div>
        <ToggleDialog />
      </Card>
